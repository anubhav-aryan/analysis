...
class Cohort18MinusAnalysis:
    ...
    def create_overall_performance_viz(self):
        ...
        bars1 = ax2.bar(x - width/2, cohort_values, width, label='18- Cohort', color='lightpink', alpha=0.7)
    ...
    def create_spotlight_analysis_viz(self):
        ...
        bars1 = ax1.bar(x - width/2, cohort_values, width, label='18- Cohort', color='lightpink', alpha=0.7)
    ...
    def create_dm_analysis_viz(self):
        ...
        if engagement_metrics:
            ...
            bars1 = ax1.bar(x - width/2, eng_cohort, width, label='18- Cohort', color='lightpink', alpha=0.7)
    ...
    def create_payment_analysis_viz(self):
        ...
        if transaction_metrics:
            ...
            ax3.plot(angles, trans_cohort, 'o-', linewidth=2, label='18- Cohort', color='pink')
            ax3.fill(angles, trans_cohort, alpha=0.25, color='pink')
    ...
    def create_comprehensive_dashboard(self):
        ...
        if section_counts:
            ...
            bars = ax6.bar(sections, counts, color='lightpink', alpha=0.7)
        ...
        if section_performance:
            ...
            ax8.plot(sections, scores, 'o-', linewidth=2, markersize=8, color='pink')
            ax8.fill_between(sections, scores, alpha=0.3, color='pink')
    ...
    def generate_business_report(self):
        ...
        # Save report
        with open('18minus_business_report.txt', 'w') as f:
            f.write('\n'.join(report))
        
        print("📋 Business report saved to '18minus_business_report.txt'")
...
def main():
    ...
    # Initialize analyzer
    analyzer = Cohort18MinusAnalysis('../Cohort Wise Analysis Fam 2.0 - Sheet1.csv')
    ...
    print("   📋 18minus_business_report.txt")
